...
import (
	"github.com/sirawann/arigato-shop/modules/files/filesHandlers"
	"github.com/sirawann/arigato-shop/modules/files/filesUsecases"
)
...
func (f *filesModule) Init() {
	...
	router.Post("/upload", f.mid.JwtAuth(), f.mid.Authorize(2), f.handler.UplaodFiles)
